...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-light-100 text-dark-900 border-b border-light-300 shadow-sm" aria-label="Main Navigation">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex flex-1 justify-center items-center space-x-10">
            ...
            >
              ...
              {/* Dropdown Menu */}
              <div 
                className={`absolute left-1/2 -translate-x-1/2 mt-2 w-72 bg-light-100 shadow-lg rounded-xl overflow-hidden transition-all duration-300 origin-top transform border border-light-300 ${
                  isProductsDropdownOpen ? 'opacity-100 scale-100 pointer-events-auto visible' : 'opacity-0 scale-95 pointer-events-none invisible'
                }`}
              >
                <div className="py-2">
                  <Link 
      ...
      <div 
        className={`md:hidden absolute w-full bg-light-100 border-t border-light-300 transition-all duration-300 ease-in-out ${
